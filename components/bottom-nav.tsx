    ...
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-40 flex items-stretch gap-2 border-t border-border bg-card px-2 py-2 shadow-[0_-2px_10px_rgba(0,0,0,0.06)]">
        ...
        <button
          ...
          className="flex flex-1 items-center justify-center rounded-full border border-foreground/15 bg-card px-3 text-[13px] font-semibold leading-tight text-foreground"
        >
          Adicionar ao
          <br />
          carrinho
